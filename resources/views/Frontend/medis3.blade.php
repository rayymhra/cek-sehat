    ...
    <div class="container">
        <div class="article-page mt-5">
            ...
            <div class="related-news">
                ...
                <div class="news-item">
                    <h4><a href="#">Cedera Ginjal Akut Meningkatkan Risiko Demensia</a></h4>
                    <p class="text-muted">Sebuah studi terbaru menemukan bahwa cedera ginjal akut...</p>
                </div>
                <div class="news-item">
                    <h4><a href="#">Pengurangan Paparan Cahaya Malam Dapat Menurunkan Risiko Diabetes Tipe 2</a></h4>
                    <p class="text-muted">Penelitian terbaru banyak menyoroti dampak negatif paparan...</p>
                </div>
            </div>
        </div>
    </div>
