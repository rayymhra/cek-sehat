...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Diabetes</h1>
            <p>Berfokus pada pemahaman dan pengelolaan diabetes untuk kesehatan yang lebih baik</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Diabetes adalah gangguan metabolisme yang ditandai dengan kadar gula darah yang tinggi. Penanganan yang tepat sangat penting untuk menjaga kualitas hidup dan mencegah komplikasi.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pengenalan Diabetes</h5>
                    <p>Informasi dasar mengenai apa itu diabetes dan bagaimana cara pengelolaannya.</p>
                    <a href="https://www.sehatq.com/penyakit/diabetes" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Diet untuk Diabetes</h5>
                    <p>Tips dan panduan mengenai diet yang tepat untuk penderita diabetes.</p>
                    <a href="https://hellosehat.com/penyakit/diabetes/diet-diabetes/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Manajemen Diabetes</h5>
                    <p>Langkah-langkah penting untuk manajemen dan pengendalian diabetes sehari-hari.</p>
                    <a href="https://www.alodokter.com/diabetes" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
