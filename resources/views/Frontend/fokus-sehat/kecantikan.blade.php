...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kecantikan</h1>
            <p>Berfokus pada perawatan dan kecantikan kulit serta tips untuk penampilan yang lebih segar</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kecantikan mencakup berbagai aspek perawatan diri untuk meningkatkan penampilan dan rasa percaya diri. Ini termasuk perawatan kulit, rutinitas kecantikan, dan tips untuk menjaga penampilan yang sehat dan segar.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Kulit Wajah</h5>
                    <p>Informasi tentang rutinitas perawatan kulit wajah dan produk yang direkomendasikan.</p>
                    <a href="https://hellosehat.com/penyakit/kulit/perawatan-kulit-wajah/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tips Kecantikan</h5>
                    <p>Tips dan trik untuk meningkatkan kecantikan alami dan menjaga kulit tetap sehat.</p>
                    <a href="https://www.alodokter.com/kecantikan" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Masker Wajah DIY</h5>
                    <p>Resep dan panduan membuat masker wajah di rumah dengan bahan alami.</p>
                    <a href="https://www.sehatq.com/artikel/resep-masker-wajah-dari-bahan-alami" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
