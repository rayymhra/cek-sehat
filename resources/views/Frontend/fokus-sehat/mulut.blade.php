...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kesehatan Mulut</h1>
            <p>Berfokus pada perawatan dan pemeliharaan kesehatan mulut, termasuk gigi dan gusi</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kesehatan mulut mencakup perawatan gigi, gusi, dan jaringan mulut lainnya. Penting untuk menjaga kesehatan mulut guna mencegah masalah gigi dan gusi serta menjaga kesehatan secara keseluruhan.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Gigi</h5>
                    <p>Informasi tentang cara merawat gigi dan mencegah kerusakan gigi.</p>
                    <a href="https://www.halodoc.com/kesehatan/gigi" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tips Kesehatan Gusi</h5>
                    <p>Tips untuk menjaga kesehatan gusi dan mencegah penyakit gusi.</p>
                    <a href="https://www.klikdokter.com/gusi" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pencegahan Masalah Mulut</h5>
                    <p>Langkah-langkah untuk mencegah masalah umum pada mulut dan gigi.</p>
                    <a href="https://www.sehatq.com/kesehatan-mulut" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
