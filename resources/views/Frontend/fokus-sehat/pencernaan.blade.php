...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Pencernaan</h1>
            <p>Berfokus pada kesehatan sistem pencernaan dan cara-cara menjaga pencernaan yang sehat.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Pencernaan melibatkan proses tubuh dalam mencerna makanan, menyerap nutrisi, dan mengeluarkan sisa-sisa yang tidak diperlukan. Menjaga kesehatan pencernaan penting untuk kesejahteraan umum.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tips Menjaga Kesehatan Pencernaan</h5>
                    <p>Informasi tentang cara menjaga kesehatan sistem pencernaan melalui pola makan dan gaya hidup.</p>
                    <a href="https://www.halodoc.com/kesehatan/pencernaan" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Penyakit Pencernaan Umum</h5>
                    <p>Tips dan panduan mengenai berbagai penyakit pencernaan dan cara penanganannya.</p>
                    <a href="https://hellosehat.com/penyakit/pencernaan/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Diet untuk Kesehatan Pencernaan</h5>
                    <p>Langkah-langkah diet yang bisa membantu menjaga kesehatan sistem pencernaan.</p>
                    <a href="https://ayosehat.kemkes.go.id/diet-pencernaan" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
