...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kesehatan Wanita</h1>
            <p>Berfokus pada kesehatan dan kesejahteraan wanita, termasuk masalah kesehatan umum dan spesifik wanita.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kesehatan wanita mencakup berbagai aspek penting dari kesehatan fisik dan mental wanita, termasuk pencegahan dan pengobatan masalah kesehatan yang umum dihadapi wanita.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Kesehatan Reproduksi Wanita</h5>
                    <p>Informasi mengenai kesehatan reproduksi wanita dan perawatannya.</p>
                    <a href="https://www.halodoc.com/kesehatan/kesehatan-wanita" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Kesehatan Wanita</h5>
                    <p>Tips dan panduan untuk merawat kesehatan wanita secara menyeluruh.</p>
                    <a href="https://hellosehat.com/keluarga/kesehatan-wanita/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pencegahan Penyakit Wanita</h5>
                    <p>Langkah-langkah untuk mencegah penyakit umum yang sering dialami wanita.</p>
                    <a href="https://ayosehat.kemkes.go.id/kesehatan-wanita" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
