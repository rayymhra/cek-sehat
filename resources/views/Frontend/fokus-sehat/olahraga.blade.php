...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Olahraga</h1>
            <p>Berfokus pada manfaat dan pentingnya olahraga untuk kesehatan dan kebugaran tubuh.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Olahraga mencakup berbagai aktivitas fisik yang dilakukan untuk meningkatkan kesehatan, kebugaran, dan kualitas hidup secara keseluruhan.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Manfaat Olahraga Rutin</h5>
                    <p>Informasi mengenai manfaat melakukan olahraga secara rutin untuk kesehatan tubuh.</p>
                    <a href="https://www.halodoc.com/kesehatan/olahraga-rutin" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tips Latihan Olahraga</h5>
                    <p>Tips dan panduan untuk melakukan latihan olahraga yang efektif dan aman.</p>
                    <a href="https://hellosehat.com/olahraga/tips-latihan/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Olahraga untuk Kesehatan Mental</h5>
                    <p>Langkah-langkah untuk memanfaatkan olahraga dalam mendukung kesehatan mental.</p>
                    <a href="https://ayosehat.kemkes.go.id/olahraga-kesehatan-mental" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
