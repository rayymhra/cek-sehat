...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <p>Berfokus pada kesejahteraan mental dan emosional serta strategi untuk menjaga kesehatan mental</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kesehatan mental mencakup aspek-aspek emosional, psikologis, dan sosial dari kesejahteraan seseorang. Penting untuk memahami dan merawat kesehatan mental untuk menjalani kehidupan yang seimbang dan produktif.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Kesehatan Mental</h5>
                    <p>Informasi dan tips mengenai cara menjaga kesehatan mental.</p>
                    <a href="https://hellosehat.com/mental/kesehatan-mental/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Strategi Mengatasi Stres</h5>
                    <p>Metode dan teknik untuk mengatasi stres dan menjaga keseimbangan mental.</p>
                    <a href="https://www.klikdokter.com/mental/strategi-mengatasi-stres" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pentingnya Dukungan Sosial</h5>
                    <p>Peran dukungan sosial dalam menjaga kesehatan mental dan emosional.</p>
                    <a href="https://www.sehatq.com/artikel/dukungan-sosial-dalam-kesehatan-mental" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
