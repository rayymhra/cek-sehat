...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Turun Berat Badan</h1>
            <p>Berfokus pada strategi dan tips untuk menurunkan berat badan secara sehat dan berkelanjutan.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Turun Berat Badan melibatkan berbagai metode dan strategi untuk mencapai dan mempertahankan berat badan yang sehat. Ini termasuk diet, olahraga, dan perubahan gaya hidup untuk membantu mencapai tujuan penurunan berat badan secara efektif.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tips Diet Sehat</h5>
                    <p>Informasi mengenai diet sehat dan bagaimana merencanakan pola makan untuk menurunkan berat badan.</p>
                    <a href="https://www.halodoc.com/penurunan-berat-badan/diet-sehat" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Olahraga untuk Menurunkan Berat Badan</h5>
                    <p>Panduan mengenai jenis olahraga yang efektif untuk membantu menurunkan berat badan.</p>
                    <a href="https://hellosehat.com/olahraga/penurunan-berat-badan/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perubahan Gaya Hidup</h5>
                    <p>Langkah-langkah perubahan gaya hidup yang dapat mendukung usaha penurunan berat badan.</p>
                    <a href="https://ayosehat.kemkes.go.id/perubahan-gaya-hidup" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
