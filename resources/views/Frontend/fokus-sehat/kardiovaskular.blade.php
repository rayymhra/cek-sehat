...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kardiovaskular</h1>
            <p>Berfokus pada kesehatan jantung dan sistem peredaran darah</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kardiovaskular merujuk pada sistem jantung dan pembuluh darah yang berfungsi mengalirkan darah ke seluruh tubuh. Masalah pada sistem ini dapat menyebabkan berbagai kondisi kesehatan serius, termasuk penyakit jantung, hipertensi, dan stroke. Penanganan dan pencegahan melibatkan gaya hidup sehat dan pemeriksaan rutin.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    ...
                    <p>Informasi mengenai berbagai jenis penyakit jantung dan faktor risikonya.</p>
                    <a href="https://hellosehat.com/penyakit/jantung/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tekanan Darah Tinggi</h5>
                    <p>Tips dan panduan mengenai pengelolaan hipertensi untuk kesehatan jantung yang lebih baik.</p>
                    <a href="https://www.alodokter.com/hipertensi" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Prevensi Stroke</h5>
                    <p>Langkah-langkah untuk mencegah stroke dan menjaga kesehatan sistem peredaran darah.</p>
                    <a href="https://www.sehatq.com/penyakit/stroke" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
