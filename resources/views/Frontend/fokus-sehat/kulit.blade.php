...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kesehatan Kulit</h1>
            <p>Berfokus pada perawatan dan kesehatan kulit untuk berbagai jenis dan kondisi kulit.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kesehatan kulit mencakup berbagai aspek penting dari perawatan kulit, termasuk pencegahan dan pengobatan masalah kulit seperti jerawat, penuaan, dan kondisi kulit lainnya.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Kulit Sehat</h5>
                    <p>Informasi terkini mengenai perawatan kulit untuk menjaga kesehatan kulit.</p>
                    <a href="https://www.halodoc.com/kesehatan/perawatan-kulit" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Kondisi Kulit Umum</h5>
                    <p>Tips dan panduan mengenai berbagai kondisi kulit dan cara mengatasinya.</p>
                    <a href="https://hellosehat.com/penyakit/kulit/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pencegahan Masalah Kulit</h5>
                    <p>Langkah-langkah untuk mencegah masalah kulit umum dan menjaga kulit tetap sehat.</p>
                    <a href="https://ayosehat.kemkes.go.id/kesehatan-kulit" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
