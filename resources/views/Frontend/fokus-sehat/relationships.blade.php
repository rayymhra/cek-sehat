...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <p>Berfokus pada kesehatan seksual dan hubungan interpersonal yang sehat.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Sex & Relationships mencakup berbagai aspek kesehatan seksual dan hubungan, termasuk komunikasi yang efektif, kesehatan seksual, dan bagaimana membangun hubungan yang sehat dan saling mendukung.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Kesehatan Seksual</h5>
                    <p>Informasi mengenai kesehatan seksual dan cara menjaga kesehatan reproduksi.</p>
                    <a href="https://www.halodoc.com/kesehatan/kesehatan-seksual" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Hubungan Sehat</h5>
                    <p>Tips dan panduan tentang membangun dan mempertahankan hubungan yang sehat dan harmonis.</p>
                    <a href="https://hellosehat.com/psikologi/psikologi-umum/relasi-berhubungan-sehat/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Komunikasi dalam Hubungan</h5>
                    <p>Strategi untuk komunikasi yang efektif dalam hubungan interpersonal.</p>
                    <a href="https://ayosehat.kemkes.go.id/komunikasi-hubungan" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
