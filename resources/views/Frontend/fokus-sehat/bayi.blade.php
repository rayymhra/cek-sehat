...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Bayi & Balita</h1>
            <p>Berfokus pada kesehatan dan kesejahteraan bayi dan anak-anak di bawah usia lima tahun</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Bayi dan Balita merujuk pada fase awal perkembangan anak dari lahir hingga usia sekitar 5 tahun.
        </p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Kesehatan Bayi</h5>
                    <p>Informasi terkini mengenai kesehatan bayi dan perawatannya.</p>
                    <a href="https://www.halodoc.com/kesehatan/kesehatan-bayi?srsltid=AfmBOorPYm3fKKqaM70le02EAmLtPSgw8aqt_0emF2gtBkiW8IzMQjBB" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perkembangan Balita</h5>
                    <p>Tips dan panduan mengenai perkembangan fisik dan mental balita.</p>
                    <a href="https://hellosehat.com/parenting/anak-1-sampai-5-tahun/perkembangan-balita/tahap-perkembangan-balita/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pencegahan Penyakit</h5>
                    <p>Langkah-langkah pencegahan penyakit umum pada bayi dan balita.</p>
                    <a href="https://ayosehat.kemkes.go.id/tips-agar-anak-tidak-sakit" target="_blank">Baca
                        Selengkapnya</a>
                </div>
            </div>
        </div>
