...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kehamilan</h1>
            <p>Berfokus pada kesehatan dan kesejahteraan selama masa kehamilan</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kehamilan adalah fase penting dalam kehidupan seorang wanita yang melibatkan perubahan fisik dan emosional. Penting untuk mendapatkan informasi dan dukungan yang tepat untuk memastikan kesehatan ibu dan bayi yang optimal selama masa kehamilan.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Kehamilan</h5>
                    <p>Informasi penting mengenai perawatan dan pemeriksaan selama kehamilan.</p>
                    <a href="https://hellosehat.com/parenting/kehamilan/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Tips Persiapan Melahirkan</h5>
                    <p>Tips dan panduan untuk mempersiapkan persalinan dan kelahiran bayi.</p>
                    <a href="https://www.klikdokter.com/kehamilan/tips-memilih-rumah-sakit-untuk-melahirkan" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Nutisi Ibu Hamil</h5>
                    <p>Informasi mengenai nutrisi dan diet yang sehat untuk ibu hamil.</p>
                    <a href="https://www.sehatq.com/artikel/pola-makan-sehat-selama-kehamilan" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
