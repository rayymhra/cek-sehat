...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kesehatan Pria</h1>
            <p>Berfokus pada kesehatan dan kesejahteraan pria, termasuk masalah kesehatan umum dan spesifik pria.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kesehatan pria mencakup berbagai aspek penting dari kesehatan fisik dan mental pria, termasuk pencegahan dan pengobatan masalah kesehatan yang umum dihadapi pria.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Masalah Kesehatan Pria</h5>
                    <p>Informasi mengenai berbagai masalah kesehatan yang sering dihadapi pria.</p>
                    <a href="https://www.halodoc.com/kesehatan/kesehatan-pria" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Kesehatan Pria</h5>
                    <p>Tips dan panduan untuk merawat kesehatan pria secara menyeluruh.</p>
                    <a href="https://hellosehat.com/keluarga/masalah-kesehatan-pria/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pencegahan Penyakit Pria</h5>
                    <p>Langkah-langkah untuk mencegah penyakit umum yang sering dialami pria.</p>
                    <a href="https://ayosehat.kemkes.go.id/kesehatan-pria" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
