...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Kesehatan Mata</h1>
            <p>Berfokus pada perawatan dan kesehatan mata untuk menjaga penglihatan yang optimal.</p>
        </div>
    </section>
    ...
    <section class="container my-5">
        <h2>Deskripsi</h2>
        <p>Kesehatan mata melibatkan perawatan dan pencegahan gangguan mata serta menjaga kesehatan penglihatan secara keseluruhan.</p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Perawatan Mata Sehat</h5>
                    <p>Informasi terkini mengenai cara merawat mata untuk menjaga kesehatan penglihatan.</p>
                    <a href="https://www.halodoc.com/kesehatan/perawatan-mata" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 2 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Kondisi Mata Umum</h5>
                    <p>Tips dan panduan mengenai berbagai kondisi mata dan cara penanganannya.</p>
                    <a href="https://hellosehat.com/penyakit/mata/" target="_blank">Baca Selengkapnya</a>
                </div>
                <!-- Resource 3 -->
                <div class="col-md-6 col-lg-4 resource-item">
                    <h5>Pencegahan Gangguan Mata</h5>
                    <p>Langkah-langkah untuk mencegah gangguan mata umum dan menjaga mata tetap sehat.</p>
                    <a href="https://ayosehat.kemkes.go.id/kesehatan-mata" target="_blank">Baca Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
